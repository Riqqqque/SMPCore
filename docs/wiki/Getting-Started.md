...
1. Learn basic server systems through `/help`, `/team`, `/reliquary`, and `/bossrituals`.
2. Build teams and gather normal materials.
3. Fight bosses to earn trophies.
4. Craft Covenant weapons, armor sets, utility relics, and boss-linked materials.
5. Use the Awakening Table and Mythic systems for endgame upgrades.
6. Staff can audit custom item origins with `/itemaudit` if suspicious duplicates appear.
